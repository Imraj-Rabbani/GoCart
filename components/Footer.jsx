    ...
    const linkSections = [
        {
            ...
            links: [
                ...
                { text: "Sweatshirt", path: '/', icon: null },
                { text: "Hoodies", path: '/', icon: null },
            ]
        },
        {
            title: "WEBSITE?",
        ...
        },
        {
            title: "CONTACT",
            links: [
                { text: "01867944012", path: '/', icon: PhoneIcon },
                { text: "gocart@gmail.com", path: '/', icon: MailIcon },
            ]
        }
    ];
            ...
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
                    <div>
                        ...
                        <p className="max-w-[410px] mt-6 text-sm">Welcome to gocart, where creativity meets commerce. Discover, design, and wear unique T-shirts by independent artists, while we handle everything else.</p>
